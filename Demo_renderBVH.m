...
% We Provide this demo to generate BVH formats. You can use this file to
% create your 3D human models with appropriate softwares like POSER
...
%======================================================================
% %-------- Produce BVH file from estimated poses-------------------------
%======================================================================
matrix_to_bvh_Edited(estimatedPose2,'Run_demo.bvh');

% Please import produced BVH file into your software (POSER, 3D max, etc)
% In Help_ImportBVH_POSER.png you can see how to import BVH into POSER
% software
